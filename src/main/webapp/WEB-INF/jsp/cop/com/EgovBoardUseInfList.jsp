...
<div id="content">
	...
	<div id="search_field">
		<div id="search_field_loc">
			<h2>
				<strong>게시판 사용정보 조회</strong>
			</h2>
		</div>
		<form name="frm" method="post"
			action="<c:url value='/cop/com/selectBBSUseInf.do'/>">
			...
			<fieldset>
				...
				<div class="sf_start">
					<ul id="search_first_ul">
						<li><select name="searchCnd" title="검색유형선력">
								<option value="0"
									<c:if test="${searchVO.searchCnd == '0'}">selected="selected"</c:if>>게시판명</option>
						</select></li>
						<li><input name="searchWrd" type="text" size="35" title="명"
					...
					<ul id="search_second_ul">
						<li>
							<div class="buttons"
								style="position: absolute; left: 870px; top: 170px;">
								<a href="<c:url value='/cop/com/selectBBSUseInfs.do'/>"
									onclick="fn_egov_select_bbsUseInfs('1'); return false;"><img
									src="<c:url value='/images/img_search.gif' />" alt="search" />조회
								</a> <a href="<c:url value='/cop/com/addBBSUseInf.do'/>"
									onclick="fn_egov_insert_addbbsUseInf(); return false;">등록</a>
							</div>
						</li>
					</ul>
				</div>
				...
				<c:forEach var="result" items="${resultList}" varStatus="status">
					...
					<tr>
						...
						<td nowrap="nowrap">
							...
							type=hidden name="trgetId"
							value="<c:out value="${result.trgetId}"/>"> <a
							href="<c:url value='/cop/com/selectBBSUseInf.do'/>?bbsId=<c:out value='${result.bbsId}'/>&amp;trgetId=<c:out value='${result.trgetId}'/>">
