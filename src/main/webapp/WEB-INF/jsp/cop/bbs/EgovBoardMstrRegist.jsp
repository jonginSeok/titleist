...
<title>게시판 생성</title>
<link type="text/css" rel="stylesheet" href="<c:url value='/'/>css/egovframework/button.css" />
...
<!-- validation error 확인 -->
<spring:hasBindErrors name="boardMaster">
	<fieldset>
		<legend>에러 건수 : ${errors.errorCount}</legend>
	...
	<form:form commandName="boardMaster" name="boardMaster" method="post" action="cop/bbs/SelectBBSMasterInfs.do">
		...
		<div id="border" class="modify_user">
			<table summary="게시판명,게시판소개,게시판 유형,게시판 속성,답장가능여부,파일첨부가능여부, ..  입니다">
				...
				<tr>
					<th width="20%" height="23" class="required_text">
						<label for="posblAtchFileNumber"> <spring:message code="cop.posblAtchFileNumber" /></label></th>
				...
				<tr>
					...
					<td width="30%" nowrap colspan="3">
						...
						<img src="<c:url value='/images/img_search.gif' />" width="15" height="15" align="middle" alt="새창" /></a>
						<br />
				...
				<c:if test="${addedOptions == 'true'}">
					...
					<tr>
						<th width="20%" height="23" class="">
							<label for="option">추가 선택사항</label></th>
						<td width="30%" nowrap colspan="3">
		...
		<div class="buttons" style="padding-top: 10px; padding-bottom: 10px;">
			...
			<table><!--  border="0" cellspacing="0" cellpadding="0" align="center" -->
				<tr>
					<td><a href="#LINK" onclick="javascript:fn_egov_regist_brdMstr(); return false;">
						<spring:message code="button.save" /></a></td>
					<td width="10"></td>
					<td><a href="#LINK" onclick="javascript:fn_egov_select_brdMstrList(); return false;">
						<spring:message code="button.list" /></a></td>
				</tr>
			</table>
		</div>
		<!-- 버튼 끝 -->
