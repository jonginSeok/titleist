...
<script type="text/javascript">
    ...
    function fn_egov_inqire_loginLog(logId){
        ...
        var url = "<c:url value ='/popup/sym/log/clg/InqireLoginLog.do?logId='/>" + logId;
				...
				<div class="sf_start">
					<ul id="search_first_ul">
						<li>발생일자 <!-- input name="searchBgnDe" type="hidden"  value="<c:out value='${searchVO.searchBgnDe}'/>" -->
							<input name="searchBgnDe" type="text" size="10"
							value="${searchVO.searchBgnDe}" readOnly
							onClick="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchBgnDe);"
							title="시작일자입력"> <a
							href="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchBgnDe);"
							style="selector-dummy: expression(this.hideFocus = false);"><img
								src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />"
								alt="달력창팝업버튼이미지" width="15" height="15"></a> ~ <!-- input name="searchEndDe" type="hidden"  value="<c:out value='${searchVO.searchEndDe}'/>"-->
							<input name="searchEndDe" type="text" size="10"
							value="${searchVO.searchEndDe}" readOnly
							onClick="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchEndDe);"
							title="종료일자입력"> <a
							href="javascript:fn_egov_NormalCalendar(document.frm, document.frm.searchEndDe);"
							style="selector-dummy: expression(this.hideFocus = false);"><img
								src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />"
								alt="달력창팝업버튼이미지" width="15" height="15"></a>
						</li>
					</ul>
						...
						<li>
							<div class="buttons" style="float: right;">
								<a href="<c:url value='/sym/log/SelectLoginLogList.do'/>"
									...
									onclick="document.frm.searchBgnDe.value=''; document.frm.searchEndDe.value=''; return false;">초기화
								</a>
							</div>
						</li>
					</ul>
				...
				<tbody>
					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						...
						<tr>
							...
							<td nowrap="nowrap"><a href="#LINK"
								onclick="javascript:fn_egov_inqire_loginLog('<c:out value="${result.logId}"/>'); return false;"
								style="selector-dummy: expression(this.hideFocus = false);"><img
									src="<c:url value='/images/search.gif'/>" alt="상세보기" width="15"
									height="15" align="middle"></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
