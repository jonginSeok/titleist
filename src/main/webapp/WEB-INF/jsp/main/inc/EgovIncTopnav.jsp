...
<script type="text/javascript">console.log('EgovIncTopnav.jsp');</script>
<!-- top menu start -->
...
<!-- menu list -->
    <form name="menuListForm" action="" method="post">
        ...
        <div style="width:0px; height:0px;"><c:forEach var="result" items="${list_menulist}" varStatus="status" > 
            <input type="hidden" name="tmp_menuNm" value="${result.menuNo}|${result.upperMenuId}|${result.menuNm}|${result.relateImagePath}|${result.relateImageNm}|${result.chkURL}|" /></c:forEach>
        </div>
    </form>
