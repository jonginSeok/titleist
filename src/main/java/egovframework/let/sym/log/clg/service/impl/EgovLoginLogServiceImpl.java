...
public class EgovLoginLogServiceImpl extends EgovAbstractServiceImpl implements EgovLoginLogService {
	...
	@Resource(name = "egovLoginLogMapper")
	private EgovLoginLogMapper egovLoginLogMapper;
	...
	public Map<String, Object> selectLoginLogInf(LoginLog loinLog) throws Exception {
		...
		//_map.put("resultList", loginLogDAO.selectLoginLogInf(loinLog)); sqlMap
		_map.put("resultList",  egovLoginLogMapper.selectLoginLogInf(loinLog)); // Mapper
